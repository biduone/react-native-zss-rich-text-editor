...
import WebViewBridge from 'react-native-webview';
...
export default class RichTextEditor extends Component {
    ...
    return (
      <View style={{ flex: 1 }}>
        <WebViewBridge
          ...
          onMessage={({ nativeEvent }) => this.onBridgeMessage(nativeEvent.data)}
  ...
  _sendAction(action, data) {
    ...
    this.webviewBridge.injectJavaScript(`WebViewBridge.execAction("${jsonString}")`);
  }
